...
// Content: Claude 06_ThreatDefend.md
...
const tiers = [
  {
    ...
    blended: '~$10',
    soc: 'Acts',
    highlights: ['Falcon EDR', 'Full ITDR', 'Dark web monitoring', 'ThreatLog SIEM'],
    popular: false,
  },
  {
    name: 'Advanced',
    ...
    blended: '~$15',
    soc: 'Acts',
    highlights: ['Falcon Discover/Spotlight', 'EASM', '15-min SLA', 'Free ThreatAssess'],
    popular: true,
  },
  {
    name: 'Premium',
    ...
    blended: '~$21',
    soc: 'Acts',
    highlights: ['Dual hunting: Vijilan + OverWatch', 'Proactive threat hunting', 'Compliance reporting'],
    popular: false,
  },
  {
    name: 'Elite',
    ...
    blended: 'Custom',
    soc: 'Dedicated',
    highlights: ['Named analyst', 'Custom SLA', 'IR retainer', 'vCISO'],
    popular: false,
  },
]
...
const faqs = [
  ...
  { q: "Is ITDR really included at the entry tier?", a: "Yes. Full ITDR is included from Essential — dark web monitoring, impossible travel, MFA fatigue, BEC, OAuth abuse, lateral movement." },
  ...
  return (
    <div className="min-h-screen bg-[#080B11]">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <h1 className="font-display text-5xl md:text-6xl font-800 text-white leading-tight mb-6">
            ...
            <span className="text-[#A78BFA]">Without hiring the team to run it.</span>
          </h1>
          <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed mb-10">
            CrowdStrike Falcon is the gold standard. Running it well is a full-time specialty. We deploy it, configure it, and operate it for you — your client never touches the console. We call it ThreatDefend. Our stack. Our SOC.
          </p>
      ...
      <section className="py-20 px-6 bg-[#0D1117]">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-400 leading-relaxed text-lg max-w-3xl">
            With ThreatDefend, Vijilan deploys and operates CrowdStrike Falcon end-to-end — EDR, NGAV, Identity Protection, and more. Praxis layers machine-speed triage and correlation on top of Falcon&apos;s telemetry, and the Vijilan SOC acts directly on confirmed threats. Your team gets enterprise-grade outcomes without becoming CrowdStrike engineers.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden p-10 border border-[#7C3AED]/20">
            ...
            {tiers.map((tier) => (
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <p className="text-xs text-slate-500 mt-2">Blended {tier.blended}</p>
                </div>
                <p className="text-xs text-[#A78BFA] mb-4">SOC: {tier.soc}</p>
                <div className="space-y-2">
                  {tier.highlights.map((h) => (
                    <div key={h} className="flex items-center gap-2 text-xs text-slate-300">
                      <CheckCircle className="w-3 h-3 text-[#7C3AED] shrink-0" />
                      {h}
                    </div>
                  ))}
                </div>
      ...
      <section className="py-24 px-6 bg-[#0D1117]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
            ...
            >
              Try ThreatAssess Free <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
        </div>
      </section>
